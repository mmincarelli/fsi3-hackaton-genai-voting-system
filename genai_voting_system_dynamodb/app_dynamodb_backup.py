        ...
        if method == 'GET' and path == '/teams':
            ...
            for team in teams:
                ...
                for vote in team_votes:
                    if float(vote['score']) == 1:  # Yes vote
                        criteria_weight = float(criteria_dict.get(vote['criteria_id'], {}).get('weight', 0))
                        total_score += criteria_weight
                
                average_score = sum(float(v['score']) for v in team_votes) / vote_count if vote_count > 0 else 0
                weighted_percentage = total_score / judge_count if judge_count > 0 else 0
                                ...
                                <div class="card mb-2">
                                    <div class="card-body">
                                        <div class="row align-items-center">
                                            ...
                                            <div class="col-md-2">
                                                <input type="text" class="form-control form-control-sm" placeholder="Comments" id="comments_${criteria.id}">
                                            </div>
                                        </div>
                                    </div>
                                </div>
